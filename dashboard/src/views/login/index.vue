<template>
  <div class="login-container">
    <el-form ref="loginForm" :model="loginForm" :rules="loginRules" class="login-form" autocomplete="on" label-position="left">
      ...
      <el-button :loading="loading" type="primary" style="width:48%;margin-bottom:30px;" @click.native.prevent="handleRegister">注册</el-button>
...
export default {
  ...
  methods: {
    ...
    handleRegister() {
      this.$axios.get('http://localhost:8080/register', {
        params: {
