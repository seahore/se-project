        ...
        <el-row>
          <el-col :span="24">
            ...
            <div class="postInfo-container">
              <el-row>
                <el-col :span="4">
                  <el-form-item label-width="60px" label="著名" class="postInfo-container-item">
                    <el-select v-model="postForm.author" :remote-method="getRemoteUserList" filterable default-first-option remote placeholder="查找用户">
...
export default {
  ...
  methods: {
    ...
    submitForm() {
      this.$axios.post('/addPassage', this.postForm)
